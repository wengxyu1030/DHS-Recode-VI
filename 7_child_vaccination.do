...
if inlist(name,"Benin2011") {
        ...
        drop c_dpt2		
		gen c_dpt2 = .
		replace c_dpt2 = 1 if (h5==1 | h5==2 | h5==3|inrange(spev1,1,3)) 
		replace c_dpt2 = 0 if h5==0 & spev1==0 
		
		drop c_dpt3
		gen c_dpt3 = .
		replace c_dpt3 = 1 if (h7==1 | h7==2 | h7==3|inrange(spev1,1,3)) 
		replace c_dpt3 = 0 if h7==0 & spev1==0 
		}
