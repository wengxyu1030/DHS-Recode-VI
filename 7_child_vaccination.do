...
if inlist(name,"Ethiopia2011"){
		...
		gen c_dpt2 = .
		replace c_dpt2 = 1 if (h5==1 | h3==2 | h5==3|inrange(sh2,1,3)) 
		replace c_dpt2 = 0 if h5==0 & sh2==0 
		
		gen c_dpt3 = .
		replace c_dpt3 = 1 if (h7==1 | h3==2 | h7==3|inrange(sh3,1,3)) 
...
if inlist(name,"KyrgyzRepublic2012"){
		...
		gen c_dpt2 = .
		replace c_dpt2 = 1 if (h5==1 | h3==2 | h5==3|inrange(s1406e2,1,3)) 
		replace c_dpt2 = 0 if h5==0 & s1406e2==0 
		
		gen c_dpt3 = .
		replace c_dpt3 = 1 if (h7==1 | h3==2 | h7==3|inrange(s1406e3,1,3)) 
