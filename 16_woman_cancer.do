...
if inlist(name, "Guatemala2014"){
	...
	ren v012 wage
	drop w_papsmear
	gen w_papsmear=0 if inrange(s1012o,0,1)
...
gen w_papsmear_ref = ""   //use string in the list: "1yr","2yr","3yr","5yr","ever"; or missing as ""
	...
	if inlist(name, "Armenia2010", "Jordan2012", "Guatemala2014", "Kenya2014", "Namibia2013"){
	...
	if inlist(name, "Guatemala2014", "Lesotho2014"){
...
gen w_papsmear_age = ""  //use string in the list: "40-49","20-59"; or missing as ""
	...
	if inlist(name, "Armenia2010", "Guatemala2014", "Jordan2012", "Kenya2014", "Lesotho2014", "Namibia2013"){
